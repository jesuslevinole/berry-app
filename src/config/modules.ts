...
export const MODULE_DEFS: ModuleDef[] = [
  ...
  { id: 'payments', label: 'Payments', hasDocuments: false },
  { id: 'purchasedetails', label: 'Purchase Details', hasDocuments: false },
  { id: 'salesdetails', label: 'Sales Details', hasDocuments: false },
